...
def run_funmixer_montecarlo(
    ...
    print("Missing in rate_constants:",
    ...
    runoff_rates = {
    k: v for k, v in runoff_rates.items()
    if k in sample_network.nodes
    }
    ...
    flux_csv = os.path.join(
        output_base,
        f"phosphate_flux_montecarlo_{season}.csv"
    )
    ...
    misfit_csv = os.path.join(
        output_base,
        f"phosphate_montecarlo_misfit_{season}.csv"
    )
    ...
    # output_base,
    # f"upstream_flux_mean_montecarlo_{season}.png"),
    # )
    ...
    #     cmap="magma",
    #     output_path= os.path.join(output_base,f"upstream_flux_uncertainty_montecarlo_{season}.png")
    # )
    return (
    upstream_flux_mean_map,
    upstream_flux_std_map,
...
output_base = "/Users/mahikabhandari/Desktop/Earth Science Year 4/MSci Project/Analysis/Modelling/DataNEW"

seasons = {
    "Autumn_2023": {
        "unmix": "/Users/mahikabhandari/Desktop/Earth Science Year 4/MSci Project/Analysis/Modelling/Phosphate_averages/Autumn 2023.csv",
        "runoff": "/Users/mahikabhandari/Desktop/Earth Science Year 4/MSci Project/Analysis/Runoff/Autumn_2023/runoff_autumn2023_mean_by_subcatchment.csv"
    },
    "Autumn_2024": {
        "unmix": "/Users/mahikabhandari/Desktop/Earth Science Year 4/MSci Project/Analysis/Modelling/Phosphate_averages/Autumn 2024.csv",
        "runoff": "/Users/mahikabhandari/Desktop/Earth Science Year 4/MSci Project/Analysis/Runoff/Autumn_2024/runoff_autumn2024_mean_by_subcatchment.csv",
    },
     "Spring_2024": {
        "unmix": "/Users/mahikabhandari/Desktop/Earth Science Year 4/MSci Project/Analysis/Modelling/Phosphate_averages/Spring 2024.csv",
        "runoff": "/Users/mahikabhandari/Desktop/Earth Science Year 4/MSci Project/Analysis/Runoff/Spring_2024/runoff_spring2024_mean_by_subcatchment.csv",
    },
    "Spring_2025": {
        "unmix": "/Users/mahikabhandari/Desktop/Earth Science Year 4/MSci Project/Analysis/Modelling/Phosphate_averages/Spring 2025.csv",
        "runoff": "/Users/mahikabhandari/Desktop/Earth Science Year 4/MSci Project/Analysis/Runoff/Spring_2025/runoff_spring2025_mean_by_subcatchment.csv",
    },
    "Summer_2024": {
        "unmix": "/Users/mahikabhandari/Desktop/Earth Science Year 4/MSci Project/Analysis/Modelling/Phosphate_averages/Summer 2024.csv",
        "runoff": "/Users/mahikabhandari/Desktop/Earth Science Year 4/MSci Project/Analysis/Runoff/Summer_2024/runoff_summer2024_mean_by_subcatchment.csv",
    },
    "Summer_2025": {
        "unmix": "/Users/mahikabhandari/Desktop/Earth Science Year 4/MSci Project/Analysis/Modelling/Phosphate_averages/Summer 2025.csv",
        "runoff": "/Users/mahikabhandari/Desktop/Earth Science Year 4/MSci Project/Analysis/Runoff/Summer_2025/runoff_summer2025_mean_by_subcatchment.csv",
    },
    "Winter_2023_2024": {
        "unmix": "/Users/mahikabhandari/Desktop/Earth Science Year 4/MSci Project/Analysis/Modelling/Phosphate_averages/Winter 2023-2024.csv",
        "runoff": "/Users/mahikabhandari/Desktop/Earth Science Year 4/MSci Project/Analysis/Runoff/Winter_2023_2024/runoff_winter_2023_2024_mean_by_subcatchment.csv",
    },
    "Winter_2024_2025": {
        "unmix": "/Users/mahikabhandari/Desktop/Earth Science Year 4/MSci Project/Analysis/Modelling/Phosphate_averages/Winter 2024-2025.csv",
        "runoff": "/Users/mahikabhandari/Desktop/Earth Science Year 4/MSci Project/Analysis/Runoff/Winter_2024_2025/runoff_winter_2024_2025_mean_by_subcatchment.csv",
    },
...
fig.subplots_adjust(bottom=0.15, top=0.92, left=0.05, right=0.97, hspace=0.3, wspace=0.2)
